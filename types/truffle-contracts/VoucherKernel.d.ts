...
export interface VoucherKernelInstance extends Truffle.ContractInstance {
  ...
  /**
   * Creating a new promise for goods or services. Can be reused, e.g. for making different batches of these (in the future).
  ...
  /**
   * Get the supply token ID from a voucher token
   * @param _tokenIdVoucher ID of the voucher token
   */
