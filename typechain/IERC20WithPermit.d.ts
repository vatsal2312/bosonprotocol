...
export interface IERC20WithPermitContract
  extends Truffle.Contract<IERC20WithPermitInstance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<IERC20WithPermitInstance>;
}
...
export interface IERC20WithPermitInstance extends Truffle.ContractInstance {
