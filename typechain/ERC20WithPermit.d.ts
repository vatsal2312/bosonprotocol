...
export interface ERC20WithPermitContract
  extends Truffle.Contract<ERC20WithPermitInstance> {
  "new"(
    _name: string,
    _symbol: string,
    meta?: Truffle.TransactionDetails
  ): Promise<ERC20WithPermitInstance>;
}
...
type AllEvents = Approval | Paused | Transfer | Unpaused;

export interface ERC20WithPermitInstance extends Truffle.ContractInstance {
